    ...
    <div className='md:w-[100%] w-[350px] md:mb-[50px]'>
        ...
        <div className=' border'>
                <div className='h-[250px]'>
                    ...
                    <div className='flex justify-start mt-5 md:mt-[30px] md:ml-[30px] md:gap-[40px] gap-5'>
                        <div>
                            <img alt="cart_pic" src="https://5.imimg.com/data5/AM/JI/WG/SELLER-68208687/rat-trap-brick.jpg"  className='w-[180px] h-[140px]'/>
                        </div>
                        <div className=''>
                            <h1 className='text-[25px] font-semibold'>Bricks </h1>
                            <h4 className='text-[25px] font-normal'>₹ 999</h4>
                            <div className='flex md:flex-row flex-col  gap-2'>
                                ...
                                <p className='text-[18px] font-normal'>Qty :111</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='h-[120px] flex justify-between px-[30px] items-center border'>
                ...
                <button  className=' mt-[20px] md:mr-[20px] bg-[#223C8C] text-[#fff] w-[175px] md:w-[150px] font-semibold h-[40px] rounded-3xl  tracking-wide leading-3 md:mb-[20px] hover:bg-blue-600 hover:text-white'>MAKE PAYMENT</button>
            </div>
        </AccordionDetails>
        </Accordion>
        ...
        <div className='h-[200px]'>
                ...
                aria-labelledby="demo-radio-buttons-group-label"
                    ...
                    <div className='flex mt-3 ml-[15px] justify-center items-center gap-3'>
        ...
        className='mt-[20px] ml-[20px] bg-[#223C8C] text-[#fff] w-[120px] md:w-[185px] font-normal md:font-semibold h-[40px] rounded-3xl  tracking-wide leading-3 mb-[20px] hover:bg-blue-600 hover:text-white'>PLACE ORDER</button>
            ...
            <Divider sx={{ marginTop:"15px",width:{md:"350px",xs:"300px"},marginLeft:"20px"}}/>
            ...
            <div className='w-[100%] md:h-[90px] h-[50px] mt-6 md:mt-[51px]  text-xl  font-bold justify-between   bg-black text-white flex items-center px-[24px]'>
                <div >Total Order</div>
                <div> 1999
                {/* {(price + (price * 0.12))>500 ? (price + (price * 0.12)):(price + (price * 0.12)+49)} */}
                </div>
