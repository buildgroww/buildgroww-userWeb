  ...
  return (
    <Box sx={{height:'80px',display:'flex',justifyContent:'space-between',alignItems:'center',padding:'0 20px',
        ...
        <Box>
            ...
            <Box sx={{display:'flex',gap:{sm:'10px',xs:'1px'},alignItems:{sm:'center'},flexDirection:{sm:'row',xs:'column'}}}>
        ...
        <Box sx={{margin:'5px 0'}}>
            <Button onClick={()=>navigate('/login')} variant='outlined' sx={{width:{sm:'100px',xs:'80px'},height:'35px',borderRadius:{sm:'18px',xs:'16px'}}}>Change</Button>
        </Box>
    </Box>
  )
}
