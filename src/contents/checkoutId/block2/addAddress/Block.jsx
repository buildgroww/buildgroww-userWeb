    ...
    <Box sx={{display:'flex',flexDirection:'column',gap:'20px'}}>
        ...
        <Box sx={{display:`${show}`,flexDirection:'column',gap:'10px',border:`1px solid ${theme.colors.alpha.black[30]}`,padding:'20px'}}>
            ...
            <Box sx={{display:'flex',alignItems:'center',gap:'30px',justifyContent:'flex-end'}}>
                ...
                <Button variant='contained' sx={{borderRadius:'5px',width:{md:'130px'}}} disabled={JSON.stringify(errors) === '{}' && values.locality!==''&&values.city!==''&&values.state!==''&&values.country!==''&&values.zipcode!==''&&checkPhone?false:true} onClick={updateAddress}>SAVE</Button>
            </Box>
        </Box>
        <div>
      <Dialog
