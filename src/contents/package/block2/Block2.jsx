...
const handleClick = () =>{
navigate(`/packagedetails/type=website&plan=basic`)
}

const handleClick1 = () =>{
  navigate(`/packagedetails/type=website&plan=advance`)
  }
  const handleClick2 = () =>{
    navigate(`/packagedetails/type=website&plan=premium`)
    }

  return (
    <Container>
    <Box sx={{display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"column"}} >
        <Typography variant='h2' sx={{fontSize:{md:"40px", sm:"32px", xs:"25px"}, fontWeight:"500", fontFamily:"Roboto", textAlign:"center"}} >Choose Your <span style={{color:"teal"}} >Website</span> Plans</Typography>
         ...
         <Card transitionDuration={{enter:400 , exit:400}}  sx={{width: {sm:"33%", xs:"90%"},cursor:"pointer", "&:hover":{transform:"scale(1.03)", transition:"all 0.4s linear"} }} onClick={handleClick} >
      <CardContent>
