...
const navigate = useNavigate()
  const handleClick = () =>{
    navigate(`/packagedetails/type=app&plan=basic`)
    }

    const handleClick1 = () =>{
      navigate(`/packagedetails/type=app&plan=advance`)
      }

      const handleClick2 = () =>{
        navigate(`/packagedetails/type=app&plan=premium`)
        }
      ...
      <CardContent>
       ...
       Basic Plan 
        ...
        <Typography variant="body2" color="text.secondary" sx={{paddingBottom:"40px", borderBottom:"2px solid #eee"}} >
            Ideal Solutions for small Apps
        </Typography>
