...
<Divider></Divider>
      ...
      <LowerContainer  position={isFixed ? "fixed" : "static"}  >
       <Button onClick={handleCart}>Add To Cart</Button>
          <Button3 onClick={handleLiveDemo} >Live Demo <VisibilityOutlined sx={{fontSize:{sm:"30px", xs:"24px",}, marginLeft:"5px"}} /> </Button3>
          <Button1 onClick={()=>{setClickType("buyNow"); setOpen(true)}}>Buy Now</Button1>
        </LowerContainer>
