...
const Block1 = ({packages,pack,setPack}) => {
  // console.log(packages)
    ...
    useEffect(() => {
      let glider = document.getElementById('packageGlider1')

      if(glider){
        new Glider(document.getElementById('packageGlider1'), {
          // Optional parameters
          slidesToShow: 1,
          slidesToScroll: 1,
          draggable: true,
          ...
          dots: ".pagination",
          arrows: {
            prev: ".packageGlider-prev1",
            next: ".packageGlider-next1"
          },
  ...
  <Container1 sx={{">div":{gap:'10px'}}} className='packageGlider-inner1' id='packageGlider1'>
...
{item.technicalDetails.dns ? 
  ...
  <span role="tablist" className="pagination"></span>
        <span className="packageGlider-prev1"><ChevronLeftIcon/></span>
        <span className="packageGlider-next1"><ChevronRightIcon/></span>
          </div>
  )
}
