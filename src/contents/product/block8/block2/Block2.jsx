...
const Block2 = ({packages,pack,setPack}) => {
  // console.log(packages)
    ...
    useEffect(() => {
      let glider = document.getElementById('packageGlider2')

      if(glider){
        new Glider(document.getElementById('packageGlider2'), {
          // Optional parameters
          slidesToShow: 1,
          slidesToScroll: 1,
          draggable: true,
          ...
          dots: ".pagination",
          arrows: {
            prev: ".packageGlider-prev2",
            next: ".packageGlider-next2"
          },
  ...
  <Container sx={{">div":{gap:'10px'}}} className='packageGlider-inner2' id='packageGlider2'>
...
{item.technicalDetails.dns ? 
  ...
  <span role="tablist" className="pagination"></span>
        <span className="packageGlider-prev2"><ChevronLeftIcon/></span>
        <span className="packageGlider-next2"><ChevronRightIcon/></span>
          </div>
          </section>
          </>
  )
