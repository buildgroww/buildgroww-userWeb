...
const Block3 = ({packages,pack,setPack}) => {
  // console.log(packages)
    ...
    useEffect(() => {
      let glider = document.getElementById('packageGlider3')

      if(glider){
        new Glider(document.getElementById('packageGlider3'), {
          // Optional parameters
          slidesToShow: 1,
          slidesToScroll: 1,
          draggable: true,
          ...
          dots: ".pagination",
          arrows: {
            prev: ".packageGlider-prev3",
            next: ".packageGlider-next3"
          },
  ...
  <Container sx={{">div":{gap:'10px'}}} className='packageGlider-inner3' id='packageGlider3'>
...
{item.technicalDetails.dns ? 
  ...
  <span role="tablist" className="pagination"></span>
        <span className="packageGlider-prev3"><ChevronLeftIcon/></span>
        <span className="packageGlider-next3"><ChevronRightIcon/></span>
          </div>
  )
}
