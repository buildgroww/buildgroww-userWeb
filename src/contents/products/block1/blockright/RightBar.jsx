...
import { Backdrop, Box, Checkbox, CircularProgress, Drawer, styled, Typography, Zoom } from '@mui/material'
...
import Block8 from '../../../product/block8/Block8'
...
const RightBar = ({ sort, setSort, query, setQuery, filter, setFilter, setMinValue, minvalue, maxvalue, setMaxValue, value, setValue, rating, setRating }) => {
  ...
  // const handleCartButton = async (e,product)=>{
  //   e.preventDefault();
  //   let item = {
  ...
  return (
    <RightContainer>
      ...
      <Block productItem={productItem}  open={openDialog} setOpen={setOpenDialog} clickType={clickType}/>
        ...
        <RightInnerContainer>
          ...
          <RightTemplateRightContainer >
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: "10px", justifyContent: "center", flexDirection: { sm: "row" }, marginLeft: { lg: "30px", md: "20px", xs: "0px" } }}>
              <Buttons sx={{cursor:'pointer'}} variant="outlined" onClick={(e)=>handleCart(e,item)}>
