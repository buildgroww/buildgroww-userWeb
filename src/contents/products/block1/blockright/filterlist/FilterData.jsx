...
const marks = [
  ...
  return (
    <FilterContainer>
      <Box sx={{display:{sm:"none", xs:"flex"}, justifyContent:"space-between", alignItems:"center", width:"75%",position:"fixed", top:"93%" ,zIndex:"100"}} >
        <Button variant="outlined" sx={{width:"45%", background:"#878787", color:"#333"}} onClick={handleReset}  > Reset</Button>
        <Button color="primary" variant="contained" sx={{width:"55%"}} onClick={handleApply} >Apply Changes</Button>
         </Box>
      <LeftItems>
