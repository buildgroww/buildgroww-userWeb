...
const Block6 = () => {
  ...
  return (
    <>
    <Typography variant='h1' sx={{ fontStyle:"Roboto", color:"#0F73EE", textAlign:"center"}} >Web Maintenance Service FAQs</Typography>
    <Container>
      ...
      <Accordion sx={{width:"100%"}}  expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary
          ...
          id="panel4bh-header"
          >
          <Typography variant='h4'  sx={{letterSpacing:"0.9px", color:'#0F73EE'}} >What is Website Maintenance?</Typography>
        </AccordionSummary>
        <AccordionDetails>
