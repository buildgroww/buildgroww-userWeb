...
export default function Item({posterLinks}) {
  ...
  return (
    <SliderContainer>
        <ImageContainer>
            <Link onClick={()=>{dispatch(updateQuery(`${posterLinks.href} website`))}} to='/products' style={{textDecoration:'none', color:`${theme.colors.alpha.black[100]}` ,"&:hover": {color:`${theme.header.background}`}}}>
