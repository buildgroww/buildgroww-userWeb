...
import Block9 from '../../../contents/product/block9/Block9'
// import { Helmet } from 'react-helmet'

const Product = ({setCheckId}) => {
  ...
  {  product &&
  <Box>
   <ProductIndex setCheckId={setCheckId} product = {product} rating={rating} setRating={setRating}  />
  {/* <Block2 product = {product} rating={rating}  /> */}
  {/* <Block7 product={product}/> */}
  <Block3  product = {product} rating={rating} products={products}  />
  <Block4 product = {product} rating={rating} />
  <Block5 product = {product} rating={rating}  />
  <Block6 product = {product} rating={rating} products={products} />
  <Block9/>
